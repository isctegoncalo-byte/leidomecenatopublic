                    ...
                    <>
                      <div>
                        ...
                        <input
                          ...
                          onChange={e => setInstitutionLegalName(e.target.value)}
                          className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none"
                        />
                      </div>
                      <div>
                ...
                <div className="space-y-3 pt-2">
                  <label className="flex items-start gap-3 p-3 border border-slate-200 rounded-xl cursor-pointer hover:bg-slate-50">
                    ...
                    <span className="text-slate-700 text-sm">
                      <strong>Consinto o tratamento dos meus dados pessoais</strong> de acordo com o RGPD para efeitos de registo, comunicação e funcionamento da plataforma. <span className="text-red-500">*</span>
                    </span>
                  </label>
                  <label className="flex items-start gap-3 p-3 border border-slate-200 rounded-xl cursor-pointer hover:bg-slate-50">
                    <input
                      type="checkbox"
                      checked={consentLogo}
                      onChange={e => setConsentLogo(e.target.checked)}
                      className="w-5 h-5 accent-blue-600 mt-0.5 flex-shrink-0"
                    />
                    <span className="text-slate-700 text-sm">
                      <strong>Autorizo a utilização do logótipo</strong> da minha {role === 'empresa' ? 'empresa' : 'instituição'} na secção de parceiros do site Lei do Mecenato.
                    </span>
                  </label>
                </div>
              )}
