                  ...
                  <div className="flex gap-5">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-sm leading-relaxed mb-3">
                        ...
                        e recebeu um PDF de 9 páginas documentando todo o impacto, com Impact Score,
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
              ...
              <div className="grid md:grid-cols-2 gap-5">
                {[
                  ...
                  { icon: '📊', title: 'Relatório ESG mais forte', desc: 'Um donativo em géneros com match exato gera um Fit Score mais elevado no relatório.' },
