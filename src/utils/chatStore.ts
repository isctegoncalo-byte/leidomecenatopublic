    ...
    messages: [
      {
        ...
        senderName: 'Sistema',
        senderRole: 'empresa',
        body: `Chat aberto para acertar os detalhes do donativo ${contract.donationType === 'dinheiro' ? 'financeiro' : 'em produtos/serviços'} no valor estimado de €${contract.donationAmount.toLocaleString('pt-PT')}.`,
        createdAt: now,
      },
    ],
  }
